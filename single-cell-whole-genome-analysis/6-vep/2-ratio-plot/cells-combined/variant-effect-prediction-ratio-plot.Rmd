---
title: "Cancer drive mutation analysis"
...
## Load sample table
```{r}
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/1-data")
...
## Load ratio results
```{r}
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/1-calculate-ratio/cells-combined")
...
- To determine how many observed variants are needed for a given O/E ratio
```{r}
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/1-calculate-ratio/cells-combined")

consequences.main.syn_non.required <- read.csv("consequence_main_synonymous_nonsynonymous_oe_mean_observed_variant_required.csv",
                                               header = TRUE, 
                                               row.names = NULL)

consequences.main.syn_non.required$cycle <- as.factor(consequences.main.syn_non.required$cycle)
consequences.main.syn_non.required <- consequences.main.syn_non.required %>% mutate(across(everything(), ~replace_na(.x, FALSE)))
```
...
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences")
...
# shape dependent on if observed variant requirement met
consequences.main.mean <- left_join(consequences.main.mean,
                                    consequences.main.syn_non.required[,c("variant_type",
                                                                          "condition",
                                                                          "cycle",
                                                                          "observed.variant.required",
                                                                          "observed.variant.requirement.met")],
                                    by = c("variant_type", "condition", "cycle"))

pdf("consequences_cycle_main_mean.pdf",
    width = 30,
    height = 30)
ggplot(consequences.main.mean, aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    ...
    labs(x = "Consequence", y = "Log2(observed/expected)\nVariants Per Cell", 
         shape = "Observed Variant Threshold") +
    ...
    scale_shape_manual(values = c(`TRUE` = 16, `FALSE` = 15), 
                       labels = c(`TRUE` = "Sufficient Observed Variants", `FALSE` = "Insufficient Observed Variants")) +
    theme_Publication() +
...
### Unnormalized
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/synonymous_nonsynonymous")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/synonymous_nonsynonymous")
...
# shape dependent on if observed variant requirement met
consequences.syn_non.mean <- left_join(consequences.syn_non.mean,
                                    consequences.main.syn_non.required[,c("variant_type",
                                                                          "condition",
                                                                          "cycle",
                                                                          "observed.variant.required",
...
consequences.syn_non.mean$observed.variant.requirement.met <- factor(consequences.syn_non.mean$observed.variant.requirement.met, 
                                           levels = c("TRUE", "FALSE"))
...
pdf("consequences.syn_non.mean.pdf",
    width = 4.6,
    height = 4)
ggplot(consequences.syn_non.mean, aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    fatten = 5) +
...
# plot
pdf("consequences.syn_non.mean_control.pdf",
    width = 4.5,
    height = 4)
ggplot(subset(consequences.syn_non.mean, condition == "control"), aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
# plot
pdf("consequences.syn_non.mean_enu.pdf",
    width = 4.5,
    height = 4)
ggplot(subset(consequences.syn_non.mean, condition == "enu"), aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
    guides(color = guide_legend(override.aes = list(shape = 16, size = 0.75), order = 1),
           shape = guide_legend(override.aes = list(size = 0.75)), order = 2) +
    scale_color_viridis(discrete = TRUE, end = 0.8, begin = 0.2) +
...
# plot
pdf("consequences.syn_non.mean.norm_control.pdf",
    width = 4.5,
    height = 4)
ggplot(subset(consequences.syn_non.mean.norm, condition == "control"), aes(x = condition, y = log2fc.norm, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
# plot
pdf("consequences.syn_non.mean.norm_enu.pdf",
    width = 4.5,
    height = 4)
ggplot(subset(consequences.syn_non.mean.norm, condition == "enu"), aes(x = condition, y = log2fc.norm, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
# shape dependent on if observed variant requirement met
# if either synonymous or nonsynonymous has sufficient observed variants, ratio is sufficient
syn_non.mean.ratio$observed.variant.requirement.met <- factor(c(FALSE,
                                                         FALSE,
                                                         TRUE,
                                                         FALSE,
                                                         TRUE),levels = c(TRUE, FALSE))
...
# plot
pdf("consequences.syn_non.mean.norm.ratio.control.pdf",
    width = 3,
    height = 4)
ggplot(subset(syn_non.mean.ratio, condition == "control"), aes(x = condition, y = log2fc.norm.ns.ratio, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm.ns.ratio - log2fc.norm.ns.ratio.sd, ymax=log2fc.norm.ns.ratio + log2fc.norm.ns.ratio.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
pdf("consequences.syn_non.mean.norm.ratio.enu.pdf",
    width = 3,
    height = 4)
ggplot(subset(syn_non.mean.ratio, condition == "enu"), aes(x = condition, y = log2fc.norm.ns.ratio, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm.ns.ratio - log2fc.norm.ns.ratio.sd, ymax=log2fc.norm.ns.ratio + log2fc.norm.ns.ratio.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
## SNV coding variants
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/snv_coding")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/snv_coding")

# intron normalization
consequences.main.mean.coding.norm <- consequences.main.mean %>%
  filter(variant_type %in% c("stop retained variant", 
                             "missense variant", 
                             "start lost", 
                             "stop gained",
                             "stop lost"))
...
consequences.main.mean.coding.norm$variant_type <- factor(consequences.main.mean.coding.norm$variant_type,
                                                        levels = c("stop retained variant", 
                                                                   "missense variant", 
                                                                   "start lost", 
                                                                   "stop gained",
                                                                   "stop lost"))
...
consequences.main.mean.coding.norm$observed.variant.requirement.met <- factor(consequences.main.mean.coding.norm$observed.variant.requirement.met, levels = c(TRUE, FALSE))

# new facet labels
labels <- c("Stop retained",
            "Missense",
            "Start lost",
            "Stop gained",
            "Stop lost")
...
# plot
pdf("consequences.main.mean.coding.pdf",
    width = 8,
    height = 4)
ggplot(consequences.main.mean.coding.norm, aes(x = condition, y = log2fc, color = cycle)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    fatten = 5) +
...
# plot
pdf("consequences.syn_non.mean.control.pdf",
    width = 8,
    height = 4)
ggplot(subset(consequences.main.mean.coding.norm, condition == "control"), aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
# plot
pdf("consequences.syn_non.mean.enu.pdf",
    width = 8,
    height = 4)
ggplot(subset(consequences.main.mean.coding.norm, condition == "enu"), aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
pdf("consequences.syn_non.mean.norm_control.pdf",
    width = 8,
    height = 4)
ggplot(subset(consequences.main.mean.coding.norm, condition == "control"), aes(x = condition, y = log2fc.norm, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
pdf("consequences.syn_non.mean.norm_enu.pdf",
    width = 8,
    height = 4)
ggplot(subset(consequences.main.mean.coding.norm, condition == "enu"), aes(x = condition, y = log2fc.norm, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
## Non-coding variants
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/snv_noncoding")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/snv_noncoding")
...
# plot
pdf("consequences_cycle_main_mean_snv_noncode.control.pdf",
    width = 8,
    height = 4)
ggplot(subset(consequences.main.mean.snv.noncode, condition == "control"), aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
# plot
pdf("consequences_cycle_main_mean_snv_noncode.enu.pdf",
    width = 9,
    height = 4)
ggplot(subset(consequences.main.mean.snv.noncode, condition == "enu"), aes(x = condition, y = log2fc, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc - log2fc.sd, ymax=log2fc + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
### Intron normalized
- Only normalize UTR and splice since these are transcribed
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/snv_noncoding")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/snv_noncoding")
...
# normalize by intron
consequences.main.mean.snv.noncode.norm <- consequences.main.mean.snv.noncode %>%
  merge(consequences.main.mean.snv.noncode[consequences.main.mean.snv.noncode$variant_type == "intron", c("condition", "cycle", "log2fc")], 
        by = c("condition", "cycle")) %>%
  mutate(log2fc.norm = if_else(variant_type %in% c("5 prime UTR variant", "3 prime UTR variant", "splice"),
                               log2fc.x - log2fc.y,
                               log2fc.x))
...
# set levels
consequences.main.mean.snv.noncode.norm$variant_type <- factor(consequences.main.mean.snv.noncode.norm$variant_type, 
                                                          levels = consequences_levels)

consequences.main.mean.snv.noncode.norm$cycle <- factor(consequences.main.mean.snv.noncode.norm$cycle, 
                                       levels = c(1, 3, 6, 9))

consequences.main.mean.snv.noncode.norm$condition <- factor(consequences.main.mean.snv.noncode.norm$condition, 
                                           levels = c("control", "enu"))
...
# plot
pdf("consequences_cycle_main_mean_snv_noncode.norm.pdf",
    width = 10,
    height = 4)
ggplot(consequences.main.mean.snv.noncode.norm, aes(x = condition, y = log2fc.norm, color = cycle)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    fatten = 5) +
...
# plot
pdf("consequences_cycle_main_mean_snv_noncode.norm.control.pdf",
    width = 8,
    height = 4)
ggplot(subset(consequences.main.mean.snv.noncode.norm, condition == "control"), aes(x = condition, y = log2fc.norm, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
# plot
pdf("consequences_cycle_main_mean_snv_noncode.norm.enu.pdf",
    width = 9,
    height = 4)
ggplot(subset(consequences.main.mean.snv.noncode.norm, condition == "enu"), aes(x = condition, y = log2fc.norm, color = cycle, shape = observed.variant.requirement.met)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_pointrange(aes(ymin=log2fc.norm - log2fc.sd, ymax=log2fc.norm + log2fc.sd),
                    position=position_dodge(width = 0.7),
                    size = 1.1) +
...
## INDEL Variants
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/indel_coding")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells-combined/consequences/indel_coding")
...
#### Synonymous
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/cycle")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/cycle")
...
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/")
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/phred/")
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/phred/cycle/")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/phred/cycle/")
...
### By cycle
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/alpha-missense")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/alpha-missense")
...
#### Mean
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/gerp")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/gerp")
...
### By cycle
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/transcription-factor")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/transcription-factor")
...
#### Mean
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phylop")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phylop")
...
#### Mean
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phastcons")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phastcons")
