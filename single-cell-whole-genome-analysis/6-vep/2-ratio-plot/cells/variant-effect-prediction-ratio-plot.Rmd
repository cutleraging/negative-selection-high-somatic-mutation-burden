...
## Load sample table
```{r}
sample_table <- read.table("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/1-data/sample_table_filtered.txt", header = TRUE, sep = "\t")
```

## Load ratio results
```{r}
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/1-calculate-ratio/cells")
...
##### Synonymous Observed vs Expected Correlation
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences")

pdf("consequences_synonymous_obs_vs_exp_correlation.pdf",
    width = 5,
    height = 5)
ggplot(consequences.syn_non.mean %>% filter(variant_type == "synonymous"), 
       aes(x = sim.mut, y = obs.mut)) +
  geom_abline(slope = 1, intercept = 0) +
  geom_jitter(size = 3, alpha = 0.5) +
  stat_cor() +
  labs(x = "Expected Number of\nSynonymous Variants", 
...
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/consequences")
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/consequences/condition")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/consequences/condition")
...
- Using mean as this allows the estimates to be more accurate
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle")
...
#### Introns
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/introns")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/introns")
...
##### Unnormalized
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/synonymous_nonsynonymous")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/synonymous_nonsynonymous")
...
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/snv_coding")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/snv_coding")
...
#### Non-coding variants
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/snv_noncoding")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/snv_noncoding")
...
consequences.main.mean.snv.noncode.norm <- consequences.main.mean.snv.noncode %>%
  merge(consequences.main.mean.snv.noncode[consequences.main.mean.snv.noncode$variant_type == "intron variant", c("sample", "log2fc")], 
        by = c("sample")) %>%
  mutate(log2fc.norm = if_else(variant_type %in% c("5 prime UTR variant", "3 prime UTR variant", "splice region variant"),
                               log2fc.x - log2fc.y,
                               log2fc.x))

# get mean and sd for each group
stats_summary <- consequences.main.mean.snv.noncode.norm %>%
  group_by(condition, cycle, variant_type) %>%
...
pdf("consequences_cycle_main_mean_snv_noncode.norm.pdf",
    width = 8,
    height = 4)
ggplot(consequences.main.mean.snv.noncode.norm, aes(x = condition, y = log2fc.norm, fill = cycle)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_boxplot(outlier.shape = NA) +
    geom_point(size = 2, alpha = 0.5, position = position_dodge(width = 0.75)) +
    guides(fill = guide_legend(override.aes = list(shape = NA))) +
...
# get the total number of obs mut and proportions
summary_total <- consequences.main.mean.snv.noncode.norm %>%
  group_by(sample, condition, cycle) %>%
  summarise(
    ...
    diff_3prime = ((obs_total_3prime + 1) - (sim_total_3prime + 1))/(sim_total_3prime + 1),
    diff_splice = ((obs_total_splice + 1) - (sim_total_splice + 1))/(sim_total_splice + 1),
    .groups = 'drop'
  )
...
write.csv(stats_summary_total, "consequences.main.mean.snv.noncode.norm.diff.csv")
...
# bar plot of frequency of reduction
...
ggplot(subset(stats_summary_total, condition == "enu"), aes(x = condition, y = mean, fill = as.factor(cycle))) + 
    ...
    labs(x = "ENU-Treated Cells",
         y = "Percent Reduction in Variants",
         fill = "Cycle") +
    scale_fill_viridis(discrete = TRUE, begin = 0.2, end = 0.8) +
    theme_Publication() +
    theme(legend.position = "top",  # Place legend on the right side
...
consequences.main.mean.snv.noncode.norm <- subset(consequences.main.mean, variant_type %in% consequences_levels)
consequences.main.mean.snv.noncode.norm$variant_type <- factor(consequences.main.mean.snv.noncode.norm$variant_type, levels = consequences_levels)
consequences.main.mean.snv.noncode.norm$cycle <- factor(consequences.main.mean.snv.noncode.norm$cycle)

# normalize by intron
consequences.main.mean.snv.noncode.norm.norm <- consequences.main.mean.snv.noncode.norm %>%
  merge(consequences.main.mean.snv.noncode.norm[consequences.main.mean.snv.noncode.norm$variant_type == "intron", c("condition", "cycle", "log2fc")], 
...
# combine p-values from each cell into group pvalue
consequences.main.mean.snv.noncode.norm.combined_pvalue <- consequences_combined_significance(consequences.main.mean.snv.noncode.norm,
                                                   c("condition", "cycle", "variant_type"),
                                                   consequences_levels)
write.csv(consequences.main.mean.snv.noncode.norm.combined_pvalue, "consequences_cycle_main_mean_snv_noncode_combined_pvalue.csv")

# calculate group pvalue with all cells as replicates
consequences.main.mean.snv.noncode.norm.cellreps_pvalue <- consequences_group_significance(consequences.main.mean.snv.noncode.norm,
                                                   c("condition", "cycle", "variant_type"),
                                                   consequences_levels)
write.csv(consequences.main.mean.snv.noncode.norm.cellreps_pvalue, "consequences_cycle_main_mean_snv_noncode_cellreps_pvalue.csv")
...
pdf("consequences_cycle_main_mean_snv_noncode.pdf",
    width = 8,
    height = 5.5)
ggplot(consequences.main.mean.snv.noncode.norm, aes(x = condition, y = log2fc, fill = cycle)) + 
    geom_hline(yintercept = 0, linetype = "dashed") +
    geom_boxplot(outlier.shape = NA) +
    geom_point(size = 2, alpha = 0.5, position = position_dodge(width = 0.75)) +
    guides(fill = guide_legend(override.aes = list(shape = NA))) +
...
#### INDEL Variants
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/indel_coding")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cells/consequences/cycle/indel_coding")
...
#### Synonymous
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/cycle")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/cycle")
...
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/")
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/phred/")
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/phred/cycle/")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/cadd/phred/cycle/")
...
### By cycle
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/alpha-missense")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/alpha-missense")
...
#### Mean
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/gerp")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/gerp")
...
### By cycle
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/transcription-factor")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/transcription-factor")
...
#### Mean
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phylop")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phylop")
...
#### Mean
```{r}
dir.create("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phastcons")
setwd("~/Dropbox (EinsteinMed)/Vijg-lab/Projects/mutation accumulation/9 cycles ENU/single-cell DNA/5-variant-effect-prediction/2-ratio-plot/phastcons")
