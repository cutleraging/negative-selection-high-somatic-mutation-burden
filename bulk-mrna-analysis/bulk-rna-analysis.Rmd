...
## Load data
```{r}
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/1-data")
...
### Save
```{r}
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis")
...
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/2-quality-control")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/2-quality-control")
...
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/3-normalization")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/3-normalization")
...
- Effect of passaging
```{r}
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/4-differential-expression")

# get results
control9_vs_control1 <- results(dds, 
                  alpha = 0.05, 
                  contrast = c("condition.cycle", "control_1", "control_9"))
...
## Control 9 vs Control 1
```{r}
dir.create("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/5-functional-enrichment")
setwd("~/EinsteinMed Dropbox/Ronald Cutler/Vijg-lab/Projects/mutation accumulation/231009 multiple ENU analysis/14-bulk-rna-analysis/5-functional-enrichment")
...
pdf("control9_vs_control1_senmayo.pdf",
    width = 5,
    height = 5)
gsearank(senmayo_gsea, 1, title = senmayo_gsea[1, "Description"]) +
  annotate("text", 10000, senmayo_gsea[, "enrichmentScore"] * .75, label = lab, hjust=0, vjust=0)
dev.off()
```
